...
#ifndef STRINGEXPRESSIONWRITTER_H
#define STRINGEXPRESSIONWRITTER_H
...
class StringExpressionWritter : public ExpressionWritter
{
	public:
		StringExpressionWritter(const Object* o);
