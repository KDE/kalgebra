...
#line 293 "exp.g"
 case 21: sym(1) = "<apply><divide />"+sym(1)+sym(3)+"</apply>"; break; 
#line 294 "exp.g"
 case 22: sym(1) = "<apply><power />" +sym(1)+sym(3)+"</apply>"; break; 
#line 295 "exp.g"
 case 23: sym(1) = "<piece>"+sym(3)+sym(1)+"</piece>"; break; 
#line 296 "exp.g"
 case 24: sym(1) = "<declare>"+sym(1)+sym(3)+"</declare>"; break; 
#line 300 "exp.g"
