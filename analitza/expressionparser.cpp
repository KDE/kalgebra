...
#line 252 "exp.g"
 case 17: sym(1)=sym(2); break; 
#line 253 "exp.g"
 case 18: sym(1)=funcToTag(sym(1)); break; 
#line 255 "exp.g"
 case 19: sym(1) = "<apply>"+sym(1)+sym(2)+"</apply>"; break; 
#line 256 "exp.g"
 case 20: sym(1) = "<apply>"+sym(1)+sym(3)+"</apply>"; break; 
#line 257 "exp.g"
 case 21: sym(1) = "<apply>"+sym(1)+       "</apply>"; break; 
#line 263 "exp.g"
...
#line 322 "exp.g"
 case 31: sym(1) = "<apply><plus />"  +sym(1)+sym(3)+"</apply>"; break; 
#line 323 "exp.g"
 case 32: sym(1) = "<apply><minus />" +sym(1)+sym(3)+"</apply>"; break; 
#line 324 "exp.g"
 case 33: sym(1) = "<apply><times />" +sym(1)+sym(3)+"</apply>"; break; 
#line 325 "exp.g"
 case 34: sym(1) = "<apply><times />" +sym(1)+sym(2)+"</apply>"; break; 
#line 326 "exp.g"
 case 35: sym(1) = "<apply><divide />"+sym(1)+sym(3)+"</apply>"; break; 
#line 327 "exp.g"
 case 36: sym(1) = "<apply><power />" +sym(1)+sym(3)+"</apply>"; break; 
#line 328 "exp.g"
 case 37: sym(1) = "<apply><eq />"    +sym(1)+sym(3)+"</apply>"; break; 
#line 329 "exp.g"
 case 38: sym(1) = "<apply><leq />"   +sym(1)+sym(3)+"</apply>"; break; 
#line 330 "exp.g"
 case 39: sym(1) = "<apply><geq />"   +sym(1)+sym(3)+"</apply>"; break; 
#line 331 "exp.g"
 case 40: sym(1) = "<apply><lt />"    +sym(1)+sym(3)+"</apply>"; break; 
#line 332 "exp.g"
 case 41: sym(1) = "<apply><gt />"    +sym(1)+sym(3)+"</apply>"; break; 
#line 333 "exp.g"
 case 42: sym(1) = "<apply><neq />"   +sym(1)+sym(3)+"</apply>"; break; 
#line 335 "exp.g"
 case 43: sym(1) = "<piece>"+sym(3)+sym(1)+"</piece>"; break; 
#line 340 "exp.g"
